...
GNSSDUMP_HELP = (
    ...
    + "  handlermode - output format for protocol handlers 0 = raw, 1 = parsed, 2 = str(parsed) (0)\n\n"
    + f"{BLUE}The following optional protocol handlers can either be instances of writeable output"
