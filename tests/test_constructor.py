...
class FillTest(unittest.TestCase):
    ...
    def testFill_CFGGNSS(self):  #  test CFG-GNSS SET multiple repeats in group
        ...
        res = UBXMessage('CFG', 'CFG-GNSS', SET, numTrkChHw=2, numTrkChUse=4, numConfigBlocks=2, gnssId_01=0, resTrkCh_01=4, maxTrkCh_01=32, gnssId_02=6, resTrkCh_02=3, maxTrkCh_02=24)
        self.assertEqual(str(res), EXPECTED_RESULT)
