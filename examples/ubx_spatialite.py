...
gnssdata table has the following fields:
    pk integer
    geom POINT
    source text
    time integer
...
SLPATH = (
    "/opt/QGIS_3.44.1/bin"  # amend path to mod_spatialite.so module in QGIS binaries
)
SQLI1 = (
...
cur = con.cursor()
# load spatialite extension to support spatial attributes
