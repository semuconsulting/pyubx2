...
Usage (all args are optional): ubxdump.py port='COM13' baud=115200 timeout=5 validate=0 raw=0
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] in {"-h", "--h", "help", "-help", "--help", "-H"}:
            print(
                ...
                "Usage (all args are optional): ubxdump.py port='COM13'",
                "baud=9600 timeout=5 validate=0 raw=0\n\n",
