...
or without a buffer wrapper). `pyubx2` implements an internal `socket_wrapper` class to allow sockets to be read in the same way as other streams (see example below).
