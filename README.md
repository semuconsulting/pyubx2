...
Sphinx API Documentation in HTML format is available in the [\docs\_build\html\](https://github.com/semuconsulting/pyubx2/tree/master/docs/_build/html) folder.
